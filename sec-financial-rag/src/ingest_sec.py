...
USER_AGENT = "FinancialDataEngineer candidate@portfolio.com"
...
if __name__ == "__main__":
    ...
    # Ingest 10-Ks for target financial/tech enterprise tickers
    target_tickers = ["AAPL", "NVDA", "MSFT", "AMZN"]
    
    for ticker in target_tickers:
        try:
            process_ticker_ingestion(ticker, minio_client, producer)
            time.sleep(1) # Respect SEC API rate limit (<=10 requests per second)
